 ...
 * @date 2021-01
 */
public class TestMenuGen implements InitFactory.Init {
    ...
    public String getMenu() {
        return SysMenuService.getMenuKey("Test", "TestMenu");
    }
    ...
    private String[][] getMenuItemsInternal() {
        String[][] menus = new String[][]{
                ...
                {"测试例子", "", "", "0", "fa " + ico(), order(), getMenu(), getParentMenu(), test_menu + "_text"},
        };
        return menus;
    }
