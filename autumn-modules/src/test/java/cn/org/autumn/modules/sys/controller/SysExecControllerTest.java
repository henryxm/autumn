...
public class SysExecControllerTest {
    ...
    public void testGetBeans_WhenNotLoggedIn_ShouldReturnNull() {
        ...
        try (MockedStatic<ShiroUtils> mockedShiroUtils = mockStatic(ShiroUtils.class)) {
            ...
            Map<String, Object> result = sysExecController.getBeans(1, 50, null);
    ...
    public void testGetBeanMethods_WhenNotLoggedIn_ShouldReturnNull() {
        ...
        try (MockedStatic<ShiroUtils> mockedShiroUtils = mockStatic(ShiroUtils.class)) {
            ...
            Map<String, Object> result = sysExecController.getBeanMethods("testBean");
    ...
    public void testExecuteBeanMethod_WhenNotLoggedIn_ShouldReturnNull() {
        ...
        try (MockedStatic<ShiroUtils> mockedShiroUtils = mockStatic(ShiroUtils.class)) {
            ...
            Map<String, Object> result = sysExecController.executeBeanMethod(request);
    ...
    public void testParameterConversion() {
        ...
        // 使用反射访问私有方法
        try {
            java.lang.reflect.Method convertMethod = SysExecController.class.getDeclaredMethod(
                "convertParameter", Object.class, Class.class);
