$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '${lang.db_databasebackup_column_strategy_id}', name: 'strategyId', index: 'strategy_id', width: 80 }, 
			...
			{ label: '${lang.db_databasebackup_column_mode}', name: 'mode', index: 'mode', width: 80 }, 
			{ label: '${lang.db_databasebackup_column_backup_tables}', name: 'backupTables', index: 'backup_tables', width: 80 }, 
			...
			{ label: '${lang.db_databasebackup_column_permanent}', name: 'permanent', index: 'permanent', width: 80 }, 
			...
			{ label: '${lang.db_databasebackup_column_total_tables}', name: 'totalTables', index: 'total_tables', width: 80 }, 
			{ label: '${lang.db_databasebackup_column_completed_tables}', name: 'completedTables', index: 'completed_tables', width: 80 }, 
			{ label: '${lang.db_databasebackup_column_current_table}', name: 'currentTable', index: 'current_table', width: 80 }, 
			{ label: '${lang.db_databasebackup_column_progress}', name: 'progress', index: 'progress', width: 80 }, 
