...
import cn.org.autumn.modules.gen.entity.ColumnEntity;
import cn.org.autumn.modules.gen.entity.TableEntity;
...
//		templates.add("template/menu.sql.vm");
	 ...
	 * 生成代码
	 */
	public static void generatorCode(List<TableMeta> table,
									 List<ColumnMeta> columns, ZipOutputStream zip){
		//配置信息
		Configuration config = getConfig();
		boolean hasBigDecimal = false;
		//表信息
		TableEntity tableEntity = new TableEntity();
		tableEntity.setTableName(table.get(0).getTableName());
		tableEntity.setComments(table.get(0).getTableComment());
		//表名转换成Java类名
