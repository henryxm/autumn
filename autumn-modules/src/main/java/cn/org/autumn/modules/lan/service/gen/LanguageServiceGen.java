...
public class LanguageServiceGen extends ServiceImpl<LanguageDao, LanguageEntity> {
    ...
    public void init() {
        ...
        String[] _m = new String[]
                {null, parent(), "国家语言", "modules/lan/language", "lan:language:list,lan:language:info,lan:language:save,lan:language:update,lan:language:delete", "1", "fa " + ico(), order(), "", "lan_language_table_comment"};
        ...
        String[][] menus = new String[][]{
                {null, id + "", "查看", null, "lan:language:list,lan:language:info", "2", null, order(), "", "sys_string_lookup"},
                {null, id + "", "新增", null, "lan:language:save", "2", null, order(), "", "sys_string_add"},
                {null, id + "", "修改", null, "lan:language:update", "2", null, order(), "", "sys_string_change"},
                {null, id + "", "删除", null, "lan:language:delete", "2", null, order(), "", "sys_string_delete"},
        };
