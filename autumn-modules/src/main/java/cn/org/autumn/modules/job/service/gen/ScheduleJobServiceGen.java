...
public class ScheduleJobServiceGen extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> {
    ...
    */
    ...
    public void addLanguageColumnItem() {
        languageService.addLanguageColumnItem("job_schedulejob_table_comment", "定时任务");
        languageService.addLanguageColumnItem("job_schedulejob_column_job_id", "任务id");
        languageService.addLanguageColumnItem("job_schedulejob_column_bean_name", "Bean名称");
        languageService.addLanguageColumnItem("job_schedulejob_column_method_name", "方法名");
        languageService.addLanguageColumnItem("job_schedulejob_column_params", "参数");
        languageService.addLanguageColumnItem("job_schedulejob_column_cron_expression", "Cron表达式");
        languageService.addLanguageColumnItem("job_schedulejob_column_status", "任务状态");
        languageService.addLanguageColumnItem("job_schedulejob_column_mode", "任务执行模式");
        languageService.addLanguageColumnItem("job_schedulejob_column_remark", "备注");
        languageService.addLanguageColumnItem("job_schedulejob_column_create_time", "创建时间");
    }
}
