...
public class LanguageService extends LanguageServiceGen implements LoadFactory.Load, LoadFactory.Must, RefreshFactory.Refresh, CategoryHandler {
    ...
    public String[][] getLanguageItems() {
        return new String[][]{
                ...
                {"sys_string_loading_description", "部分资源暂未就绪，请稍候，系统将自动重试。", "Some resources are not ready yet. Please wait, the system will retry automatically."},
                {"sys_string_loading_retry_now", "立即重试", "Retry now"},
