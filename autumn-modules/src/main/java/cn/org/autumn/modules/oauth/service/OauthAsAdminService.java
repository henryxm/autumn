...
public class OauthAsAdminService {
    ...
    public Map<String, Object> overview() {
        ...
        data.put("clientCount", clientDetailsService.selectCount(new EntityWrapper<>()));
        data.put("trustedCount", clientDetailsService.selectCount(new EntityWrapper<ClientDetailsEntity>().eq("trusted", 1)));
        data.put("activeCount", clientDetailsService.selectCount(new EntityWrapper<ClientDetailsEntity>().eq("archived", 0)));
        data.put("tokenCount", tokenStoreService.selectCount(new EntityWrapper<>()));
        return data;
    }

    public PageUtils pageClients(Map<String, Object> params) {
        EntityWrapper<ClientDetailsEntity> wrapper = new EntityWrapper<>();
    ...
    public PageUtils pageTokens(Map<String, Object> params) {
        EntityWrapper<TokenStoreEntity> wrapper = new EntityWrapper<>();
        AdminPageQueries.applyKeyword(wrapper, params, "user_uuid", "access_token", "refresh_token", "auth_code");
        wrapper.orderBy(WrapperColumns.columnInWrapper("update_time"), false);
