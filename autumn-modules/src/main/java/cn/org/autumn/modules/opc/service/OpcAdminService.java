...
public class OpcAdminService {
    ...
    public PageUtils pageApps(Map<String, Object> params) {
        QueryWrapper<ConnectAppEntity> wrapper = new QueryWrapper<>();
        AdminPageQueries.applyKeyword(wrapper, params, "name", "app_id", "user", "platform_base_url");
        PageUtils page = connectAppService.queryPage(connectAppService.getPage(params, "create"), wrapper);
        enrichAppRows(page);
        return page;
    }
    ...
    public PageUtils pageBinds(Map<String, Object> params) {
        QueryWrapper<ConnectBindEntity> wrapper = new QueryWrapper<>();
        ...
        PageUtils page = connectBindService.queryPage(connectBindService.getPage(params, "create"), wrapper);
        enrichBindRows(page);
        return page;
    }
    ...
    private ConnectAppEntity findAppByUuid(String uuid) {
        ...
        ConnectAppEntity app = connectAppService.getOne(new QueryWrapper<ConnectAppEntity>().eq("uuid", uuid));
        connectAppService.stripSecret(app);
        return app;
    }
    ...
    private OpcAppAdminView toAppView(ConnectAppEntity app) {
        ...
        view.setBindCount(connectBindService.selectCount(new QueryWrapper<ConnectBindEntity>().eq("connect_app", app.getUuid())));
