...
public class OauthRpAdminService {
    ...
    public Map<String, Object> overview() {
        ...
        data.put("clientCount", webAuthenticationService.selectCount(new EntityWrapper<>()));
        data.put("bindCount", webOauthBindService.selectCount(new EntityWrapper<>()));
        return data;
    }
    ...
    public PageUtils pageBinds(Map<String, Object> params) {
        EntityWrapper<WebOauthBindEntity> wrapper = new EntityWrapper<>();
    ...
    private OauthRpClientView toClientView(WebAuthenticationEntity entity) {
        ...
        view.setBindCount(webOauthBindService.selectCount(new EntityWrapper<WebOauthBindEntity>().eq("authentication", entity.getUuid())));
