...
| **Autumn 系 RP 联邦登录（A应用→B网站）** | **`docs/AI_SCAN_LOGIN_FLOWS.md` §3.3** → **`docs/AI_AUTH_SITE_ROLES.md`** |

### 快速索引

| 需求 | 文档章节 |
|------|----------|
| AS/RP 双角色与 A应用+B网站 | **`AI_AUTH_SITE_ROLES.md`** |
...
| **时序图 / 拓扑 / 鉴权** | **`AI_SCAN_LOGIN_FLOWS.md`** |
