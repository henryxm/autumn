...
- （接口加解密改造）@../autumn/docs/AI_CRYPTO.md
- （模块新建/生成链路）@../autumn/docs/AI_TEMPLATES.md
- （规范治理/多人协作）@../autumn/docs/AI_GOVERNANCE.md
- （仅安全专项任务需要）@../autumn/docs/AI_SECURITY.md
- @./README.md
- @./src  （或对应后端目录）
...
- 遵守 `docs/AI_STANDARDS.md`（分层、API、gen 隔离、定时任务、`@RequiresPermissions`、FTL、**禁止 DDL .sql**、**Dao 只用 Provider**、**Controller 禁用 Dao**、**statics/pages/Site**）
```
