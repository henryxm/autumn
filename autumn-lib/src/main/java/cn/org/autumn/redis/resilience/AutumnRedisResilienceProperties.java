...
public class AutumnRedisResilienceProperties {
    ...
    public static class Lock {
        ...
        public boolean isSkipRedissonWhenCircuitOpen() {
            return skipRedissonWhenCircuitOpen;
        }

        public void setSkipRedissonWhenCircuitOpen(boolean skipRedissonWhenCircuitOpen) {
            this.skipRedissonWhenCircuitOpen = skipRedissonWhenCircuitOpen;
        }
    }
}
