...
public class AExceptionHandler {
    ...
    public Response<?> handleRRException(AException e, HttpServletRequest request) {
    ...
    public Response<?> handleCodeException(CodeException e, HttpServletRequest request) {
        if (log.isDebugEnabled())
            log.debug("请求方式:{}, 路径:{}, 代码:{}, 错误:{}", request.getMethod(), request.getRequestURI(), e.getCode(), e.getMessage(), e);
        return Response.error(e);
    }
    ...
    public Response<?> handleDuplicateKeyException(DuplicateKeyException e, HttpServletRequest request) {
        if (log.isDebugEnabled())
    ...
    public Response<?> handleHttpMediaTypeNotAcceptableException(HttpMediaTypeNotAcceptableException e, HttpServletRequest request) {
        if (log.isDebugEnabled())
    ...
    public Response<?> handleHttpMessageNotReadableException(HttpMessageNotReadableException e, HttpServletRequest request) {
        if (log.isDebugEnabled())
